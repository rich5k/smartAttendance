...
<head>
    ...
    <title>Course Faculty Inquiry</title>
...
<body>
   ...
   <div class="container jumbotron course course_essen">
        <h3>Do you want to add more lecturers to this course?</h3>
        <br>
        <div class="row">
            <div class="col-lg-6">
                <button onclick="location.href = './course_faculty.php';" type="button" class="btn btn-success">Yes 👍 </button>
