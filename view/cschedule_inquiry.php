...
<head>
    ...
    <title>Course Schedule Inquiry</title>
...
<body>
   ...
   <div class="container jumbotron course course_essen">
        <h3>Do you want to add more days and times to this course?</h3>
        <br>
        <div class="row">
            <div class="col-lg-6">
                <button onclick="location.href = './course_schedule.php';" type="button" class="btn btn-success">Yes 👍 </button>

            </div>
            <div class="col-lg-6">
                <button onclick="location.href = './reg_welcome.php';" type="button" class="btn btn-danger">No 👎 </button>
